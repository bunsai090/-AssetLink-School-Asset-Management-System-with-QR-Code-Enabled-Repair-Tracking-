...
const TeacherProfile = () => {
    ...
    const handleInfoUpdate = async (e) => {
        ...
        try {
            ...
            // Update Firebase Auth profile name as well
    ...
    const handleImageUpload = async (e) => {
        ...
        try {
            // Using XHR for real progress tracking
            ...
            xhr.onload = async () => {
                if (xhr.status === 200) {
                    ...
                    try {
                        ...
                        toast.success("Profile picture updated via Cloudinary!");
                    } catch (err) {
                        console.error("Firebase Update Error:", err);
                        toast.error("Cloudinary upload success, but failed to link to your account.");
                    } finally {
            ...
            <div className="container mx-auto px-6 -mt-16 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="border-slate-100 bg-slate-900 text-white overflow-hidden relative">
                            <div className="absolute top-0 right-0 w-32 h-32 bg-[#028a0f] rounded-full blur-[80px] opacity-20" />
                            <CardContent className="p-6 relative z-10">
                                <h3 className="font-bold text-lg mb-2">Need help?</h3>
                                <p className="text-slate-400 text-sm mb-4 leading-relaxed">
                                    If you are having trouble with your account or have concerns about your assets, contact our support.
                                </p>
                                <Button variant="secondary" className="w-full font-bold bg-white/10 hover:bg-white/20 border-0 text-white">
                                    Contact Admin
                                </Button>
                            </CardContent>
                        </Card>
                                ...
                                <form onSubmit={handleInfoUpdate} className="space-y-6">
                                    ...
                                    <div className="flex justify-end">
                                        <Button 
                                            type="submit" 
                                            disabled={isLoading}
                                            className="h-12 px-8 bg-[#028a0f] hover:bg-[#016d0c] text-white font-bold rounded-xl shadow-lg shadow-green-900/10 gap-2 transition-all active:scale-95"
                                        >
                                ...
                                <form onSubmit={handlePasswordUpdate} className="space-y-6">
                                    ...
                                    <div className="flex justify-end">
                                        <Button 
                                            ...
                                            className="h-12 px-8 bg-slate-900 hover:bg-black text-white font-bold rounded-xl shadow-lg shadow-slate-900/10 gap-2 transition-all active:scale-95"
                                        >
