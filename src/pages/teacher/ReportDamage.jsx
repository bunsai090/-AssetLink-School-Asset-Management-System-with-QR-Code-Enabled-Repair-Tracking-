...
export default function ReportDamage() {
    ...
    return (
        <div className="max-w-7xl mx-auto animate-in fade-in slide-in-from-bottom-4 duration-500">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 px-4 mb-8">
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        <div className="w-1.5 h-6 bg-teal rounded-full" />
                        <h1 className="text-3xl font-black text-slate-900 tracking-tight">Report Damage</h1>
                    </div>
                    <p className="text-slate-500 text-sm font-medium tracking-tight">Capture and describe asset damage to request a repair.</p>
                </div>
            </div>
