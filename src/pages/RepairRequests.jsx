            ...
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 px-1">
                <div>
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <h1 className="text-3xl font-black text-slate-900 tracking-tight">Repair Requests</h1>
                    </div>
                    <p className="text-slate-500 text-sm font-medium tracking-tight">Track and manage all damage reports across the school.</p>
                </div>
            </div>
